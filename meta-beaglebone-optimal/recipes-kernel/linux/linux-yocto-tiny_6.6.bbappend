...
# Feature catalog, shared across machines. Enabled state comes from
# DISTRO_FEATURES, declared per machine.conf (see the bbclass).

# GPIO_LEDS: BBB USR0 heartbeat LED.
LINUX_YOCTO_TINY_FEATURE_GPIO_LEDS_TOKEN = "optimal-gpio-leds"
...
LINUX_YOCTO_TINY_FEATURE_I2C2_BUS_TOKEN = "optimal-i2c2-bus"
...
LINUX_YOCTO_TINY_FEATURE_RTC_DS3231_TOKEN = "optimal-rtc-ds3231"
...
LINUX_YOCTO_TINY_FEATURE_RTC_DS3231_REQUIRES = "I2C2_BUS"

# SHT3X: hwmon over i2c2 at 0x44 (needs I2C2_BUS).
LINUX_YOCTO_TINY_FEATURE_SHT3X_TOKEN = "optimal-sht3x"
...
LINUX_YOCTO_TINY_FEATURE_SHT3X_REQUIRES = "I2C2_BUS"

# BH1750: IIO light sensor over i2c2 at 0x23 (needs I2C2_BUS).
LINUX_YOCTO_TINY_FEATURE_BH1750_TOKEN = "optimal-bh1750"
...
LINUX_YOCTO_TINY_FEATURE_BH1750_REQUIRES = "I2C2_BUS"
...
# DEV-ONLY: NFS-root + USB gadget, gated on DISTRO_FEATURES.
FILESEXTRAPATHS:prepend:beaglebone-black-optimal-qt-dashboard-dev := "${THISDIR}/files-qt-dashboard-dev:"

KERNEL_FEATURES:append = "${@bb.utils.contains('DISTRO_FEATURES', 'optimal-netboot-dev', ' beaglebone-qt-dashboard-dev-netboot.scc', '', d)}"

SRC_URI:append = "${@bb.utils.contains('DISTRO_FEATURES', 'optimal-netboot-dev', ' file://beaglebone-qt-dashboard-dev-netboot.cfg file://beaglebone-qt-dashboard-dev-netboot.scc', '', d)}"
