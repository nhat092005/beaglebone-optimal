...
let additionalContext = "Run `bd prime` manually if you need Beads workflow context.";
...
try {
  ...
  if (stdout) {
    // Keep startup context bounded so the hook cannot flood the session payload.
