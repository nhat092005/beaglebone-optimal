...
This project is indexed by GitNexus as **beaglebone-optimal** (13 symbols, 11 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
